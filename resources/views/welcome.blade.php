    ...
    <div class="max-w-7xl mx-auto">
        <div>
            <img class="h-32 w-full object-cover lg:h-48"
                src="https://pbs.twimg.com/profile_banners/135489001/1726037363/1500x500" alt="">
        </div>
        <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div class="-mt-12 sm:-mt-16 sm:flex sm:items-end sm:space-x-5">
                <div class="flex">
                    <img class="size-24 rounded-full ring-4 ring-white sm:size-32"
                        src="https://media.licdn.com/dms/image/v2/D4D03AQHhiq40to-7Bg/profile-displayphoto-shrink_400_400/B4DZU9WG7mHIAg-/0/1740490961078?e=1749686400&v=beta&t=TDPql35HB0KXETCRZ6DxF3yVI7rJlVIHKam4dDta-fA"
                        alt="">
                </div>
